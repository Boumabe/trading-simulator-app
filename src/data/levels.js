export const LEVELS = [
  { id: 1, name: "Support", tier: "PALIER 1 — FONDATIONS", strategyId: "support" },
  { id: 2, name: "Résistance", tier: "PALIER 1 — FONDATIONS", strategyId: "resistance" },
  { id: 3, name: "Tendance haussière/baissière", tier: "PALIER 1 — FONDATIONS", strategyId: "trend" },
  { id: 4, name: "Lignes de tendance", tier: "PALIER 1 — FONDATIONS", strategyId: "trendline" },
  { id: 5, name: "Canaux de prix", tier: "PALIER 1 — FONDATIONS", strategyId: "channel" },
  { id: 6, name: "Zones de range", tier: "PALIER 1 — FONDATIONS", strategyId: "range" },
  { id: 7, name: "Breakout et retest", tier: "PALIER 1 — FONDATIONS", strategyId: "breakout" },
  { id: 8, name: "Pin bar / marteau", tier: "PALIER 2 — CHANDELIERS", strategyId: "pinbar" },
  { id: 9, name: "Engulfing", tier: "PALIER 2 — CHANDELIERS", strategyId: "engulfing" },
  { id: 10, name: "Doji", tier: "PALIER 2 — CHANDELIERS", strategyId: "doji" },
  { id: 11, name: "Étoile du matin/soir", tier: "PALIER 2 — CHANDELIERS", strategyId: "morningstar" },
  { id: 12, name: "Inside bar", tier: "PALIER 2 — CHANDELIERS", strategyId: "insidebar" },
  { id: 13, name: "Trois soldats / corbeaux", tier: "PALIER 2 — CHANDELIERS", strategyId: "threesoldiers" },
  { id: 14, name: "Tête-épaules", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "headshoulders" },
  { id: 15, name: "Double top / bottom", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "doubletop" },
  { id: 16, name: "Triangle", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "triangle" },
  { id: 17, name: "Drapeau et fanion", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "flag" },
  { id: 18, name: "Biseau (wedge)", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "wedge" },
  { id: 19, name: "Cup and handle", tier: "PALIER 3 — FIGURES CHARTISTES", strategyId: "cuphandle" },
  { id: 20, name: "Moyennes mobiles", tier: "PALIER 4 — INDICATEURS", strategyId: "ma" },
  { id: 21, name: "RSI", tier: "PALIER 4 — INDICATEURS", strategyId: "rsi" },
  { id: 22, name: "MACD", tier: "PALIER 4 — INDICATEURS", strategyId: "macd" },
  { id: 23, name: "Bandes de Bollinger", tier: "PALIER 4 — INDICATEURS", strategyId: "bollinger" },
  { id: 24, name: "Stochastique", tier: "PALIER 4 — INDICATEURS", strategyId: "stoch" },
  { id: 25, name: "ATR", tier: "PALIER 4 — INDICATEURS", type: "quiz", quizId: "atr" },
  { id: 26, name: "Fibonacci retracement", tier: "PALIER 4 — INDICATEURS", strategyId: "fibo" },
  { id: 27, name: "Fibonacci extension", tier: "PALIER 4 — INDICATEURS", strategyId: "fiboext" },
  { id: 28, name: "Volume basique", tier: "PALIER 5 — VOLUME & FLUX", strategyId: "volume" },
  { id: 29, name: "VWAP", tier: "PALIER 5 — VOLUME & FLUX", strategyId: "vwap" },
  { id: 30, name: "Volume Profile", tier: "PALIER 5 — VOLUME & FLUX", strategyId: "volumeprofile" },
  { id: 31, name: "Zones de liquidité", tier: "PALIER 5 — VOLUME & FLUX", strategyId: "liquidityzones" },
  { id: 32, name: "Order flow", tier: "PALIER 5 — VOLUME & FLUX", type: "quiz", quizId: "orderflow" },
  { id: 33, name: "Order blocks (ICT)", tier: "PALIER 6 — SMART MONEY", strategyId: "orderblock" },
  { id: 34, name: "Fair Value Gap", tier: "PALIER 6 — SMART MONEY", strategyId: "fvg" },
  { id: 35, name: "Liquidity sweep", tier: "PALIER 6 — SMART MONEY", strategyId: "liquiditysweep" },
  { id: 36, name: "Breaker block", tier: "PALIER 6 — SMART MONEY", strategyId: "breakerblock" },
  { id: 37, name: "CHoCH / BOS", tier: "PALIER 6 — SMART MONEY", strategyId: "chochbos" },
  { id: 38, name: "Zones premium/discount", tier: "PALIER 6 — SMART MONEY", strategyId: "premiumdiscount" },
  { id: 39, name: "Kill zones", tier: "PALIER 6 — SMART MONEY", strategyId: "killzones" },
  { id: 40, name: "Optimal Trade Entry", tier: "PALIER 6 — SMART MONEY", strategyId: "ote" },
  { id: 41, name: "Corrélations inter-marchés", tier: "PALIER 7 — CONTEXTE MACRO", type: "quiz", quizId: "correlation" },
  { id: 42, name: "Sessions de trading", tier: "PALIER 7 — CONTEXTE MACRO", strategyId: "sessions" },
  { id: 43, name: "News économiques", tier: "PALIER 7 — CONTEXTE MACRO", strategyId: "news" },
  { id: 44, name: "Sentiment / COT", tier: "PALIER 7 — CONTEXTE MACRO", type: "quiz", quizId: "sentiment" },
  { id: 45, name: "S/R + chandelier", tier: "PALIER 8 — CONFLUENCE", strategyId: "confluencesr" },
  { id: 46, name: "ICT + Fibonacci", tier: "PALIER 8 — CONFLUENCE", strategyId: "confluenceictfibo" },
  { id: 47, name: "Multi-timeframe", tier: "PALIER 8 — CONFLUENCE", type: "quiz", quizId: "multitf" },
  { id: 48, name: "Système personnalisé", tier: "PALIER 8 — CONFLUENCE", type: "tool" },
];

export const RECOMMENDED_BY_LEVEL = { debutant: 1, intermediaire: 8, avance: 33 };
...
export const STRATEGY_DATA = {
  ...
  stoch: {
    ...
    candles: [
      ...
      { path: [88, 91] }, { path: [91, 95] }, { path: [95, 99] }, { path: [99, 103] },
      { path: [103, 106] }, { path: [106, 104] }, { path: [104, 108] }, { path: [108, 111] },
    ],
  },
  fibo: {
